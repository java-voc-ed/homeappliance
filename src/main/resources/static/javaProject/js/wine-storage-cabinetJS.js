$(document).ready(() => {
  ...
  const fetchProducts = () => {
    ...
    $.get('http://localhost:8080/api/in/v1/products/categories/wine-storage-cabinet', result);
        ...
        <div class="card product-item">
          <div class="card-thumb">
            <a class="card-img" href="#">
              <img src="/javaProject/images/Wine_storage_cabinet/${product.sku}/0.jpg" alt="">
