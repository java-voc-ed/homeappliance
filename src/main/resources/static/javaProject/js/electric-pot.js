$(document).ready(() => {
    ...
    const fetchProducts = () => {
        ...
        $.get('http://localhost:8080/api/in/v1/products/categories/electric-pot',result); 
        ...
        <div class="card product-item">
          <div class="card-thumb">
            <a class="card-img" href="#">
              <img src="/javaProject/images/fridge/four/四門1.jpg" alt="">
          ...
          <div class="card-footer d-flex justify-content-between">
            <a href="/javaProject/cart.html" class="btn btn-block" data-product-id="${product.pid}">加入購物車</a>
          </div>
        </div>
      </li>
        `);
